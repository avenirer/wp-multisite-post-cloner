...
if ( ! class_exists( 'Multisite_Post_Cloner' ) ) {

	/**
	 * The main class for the Multisite Post Cloner plugin.
	 */
	class Multisite_Post_Cloner {
		...
		private function load_dependencies(): void {
			require_once plugin_dir_path( __FILE__ ) . 'class-multisite-post-cloner-admin.php';
			require_once plugin_dir_path( __FILE__ ) . 'class-multisite-post-cloner-actions.php';
		}
		...
		private function define_admin_hooks(): void {
			$plugin_admin = new Multisite_Post_Cloner_Admin();
			...
			$plugin_actions = new Multisite_Post_Cloner_Actions();
